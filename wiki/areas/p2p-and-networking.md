...
- Fuzz: `src/test/fuzz/p2p_handshake.cpp`, `src/test/fuzz/bip324.cpp`, `src/test/fuzz/addrman.cpp`, `src/test/fuzz/banman.cpp`, `src/test/fuzz/txrequest.cpp`, `src/test/fuzz/txdownloadman.cpp`.
