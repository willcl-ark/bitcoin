...
if(CMAKE_BUILD_TYPE STREQUAL "Coverage" AND NOT CMAKE_CXX_COMPILER_ID MATCHES "^(Apple)?Clang$")
  message(FATAL_ERROR "The Coverage build type requires Clang.")
endif()

set(CMAKE_C_FLAGS_COVERAGE "-g -Og -fprofile-instr-generate -fcoverage-mapping")
set(CMAKE_CXX_FLAGS_COVERAGE "-g -Og -fprofile-instr-generate -fcoverage-mapping")
set(CMAKE_OBJCXX_FLAGS_COVERAGE "-g -Og -fprofile-instr-generate -fcoverage-mapping")
...
set(CMAKE_MODULE_LINKER_FLAGS_COVERAGE "-fprofile-instr-generate -fcoverage-mapping")
get_property(is_multi_config GLOBAL PROPERTY GENERATOR_IS_MULTI_CONFIG)
if(is_multi_config)
