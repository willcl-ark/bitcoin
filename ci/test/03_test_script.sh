...
BITCOIN_CONFIG_ALL="$BITCOIN_CONFIG_ALL -DBITCOIN_FUNCTIONAL_TEST_COVERAGE=$FUNCTIONAL_TEST_COVERAGE -DBITCOIN_FUNCTIONAL_EXTENDED_TESTS=$FUNCTIONAL_EXTENDED_TESTS"
