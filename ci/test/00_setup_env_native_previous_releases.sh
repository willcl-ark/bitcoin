...
export TEST_RUNNER_EXTRA="--previous-releases --coverage --extended --exclude feature_dbcrash"  # Run extended tests for coverage, but exclude the very slow dbcrash
export GOAL="install"
