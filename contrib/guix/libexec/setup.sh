...
# Generated by the selected Scheme toolchain and exposed from its assembly.
# Apply this after clearing the Guix shell profile's default search paths.
# shellcheck disable=SC1090
source "${TOOLCHAIN_ENVIRONMENT:?not set}"
