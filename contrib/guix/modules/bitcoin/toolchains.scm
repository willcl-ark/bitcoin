(define-module (bitcoin toolchains)
  ...
  #:use-module ((gnu packages llvm) #:select (clang-toolchain-19
                                              libcxx
                                              lld-19))
...
FILE-NAME found in ./patches relative to the Guix directory."
  (parameterize
      ((%patch-path (list (string-append %guix-directory "/patches"))))
...
(define (target-toolchain-packages target)
