...
class DumptxoutsetTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(out["base_hash"], "6885775faa46290bedfa071f22d0598c93f1d7e01f24607c4dedd69b9baa4a8f")

        # UTXO snapshot hash should be deterministic based on mocked time.
        assert_equal(
            sha256sum_file(str(expected_path)).hex(), "d9506d541437f5e2892d6b6ea173f55233de11601650c157a27d8f2b9d08cb6f"
        )

        assert_equal(out["txoutset_hash"], "d4453995f4f20db7bb3a604afd10d7128e8ee11159cde56d5b2fd7f55be7c74c")
        assert_equal(out["nchaintx"], 101)

        # Specifying a path to an existing or invalid file will fail.
        assert_raises_rpc_error(-8, "{} already exists".format(FILENAME), node.dumptxoutset, FILENAME, "latest")
        ...
        self.log.info(
            "Test that dumptxoutset failure does not leave the network activity suspended when it was on previously"
        )
