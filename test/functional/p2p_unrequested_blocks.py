...
class AcceptBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(
            -1, "Block not available (not fully downloaded)", self.nodes[0].getblock, block_h1f.hash
        )
        ...
        assert_raises_rpc_error(
            -1, "Block not available (not fully downloaded)", self.nodes[0].getblock, all_blocks[-1].hash
        )
        ...
        assert_raises_rpc_error(
            -1, "Block not available (not fully downloaded)", self.nodes[0].getblock, all_blocks[287].hash
        )
        ...
        assert tip_entry_found
        assert_raises_rpc_error(
            -1, "Block not available (not fully downloaded)", self.nodes[0].getblock, block_292.hash
        )
