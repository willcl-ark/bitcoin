...
class ChainstateWriteCrashTest(BitcoinTestFramework):
    ...
    def restart_node_until_tip(self, node_index, expected_tip):
        ...
        for i in range(3):
            ...
            for (block_hash, block) in blocks:
                ...
                if not self.submit_block_catch_error(i, block):
                    ...
                    nodei_utxo_hash = self.restart_node_until_tip(i, block_hash)
    ...
    def verify_utxo_hash(self):
        ...
        for i in range(3):
            try:
                ...
                nodei_utxo_hash = self.restart_node_until_tip(i, self.nodes[3].getbestblockhash())
            assert_equal(nodei_utxo_hash, node3_utxo_hash)
