...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decoderawtransaction_asm_sighashtype(self):
        ...
        assert_equal(
            "OP_HASH160 2a5edea39971049a540474c6a99edf0aa4074c58 OP_EQUAL", rpc_result["vout"][1]["scriptPubKey"]["asm"]
        )
        ...
        assert_equal(
            "OP_HASH160 3011020701010101010101020601010101010101 OP_EQUAL", rpc_result["vout"][1]["scriptPubKey"]["asm"]
        )
    ...
    def decodescript_datadriven_tests(self):
        with open(
            os.path.join(os.path.dirname(os.path.realpath(__file__)), "data/rpc_decodescript.json"), encoding="utf-8"
        ) as f:
    ...
    def decodescript_miniscript(self):
        ...
        assert (
            res["segwit"]["desc"] == "addr(bcrt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xsvxg6uu)#9p3q328s"
        )
