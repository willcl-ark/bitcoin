...
BECH32_TWO_ERRORS = (
    "bcrt1qax9suht3qv95sw33xavx8crpxduefdrsvgsklu"  # should be bcrt1qax9suht3qv95sw33wavx8crpxduefdrsvgsklx
)
...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(
            -3, "JSON value of type null is not of expected type string", node.validateaddress, None
        )
    ...
    def test_getaddressinfo(self):
        ...
        assert_raises_rpc_error(
            -5, "Invalid or unsupported Segwit (Bech32) or Base58 encoding.", node.getaddressinfo, BECH32_INVALID_PREFIX
        )
        assert_raises_rpc_error(
            -5, "Invalid or unsupported Base58-encoded address.", node.getaddressinfo, BASE58_INVALID_PREFIX
        )
        assert_raises_rpc_error(
            -5, "Invalid or unsupported Segwit (Bech32) or Base58 encoding.", node.getaddressinfo, INVALID_ADDRESS
        )
