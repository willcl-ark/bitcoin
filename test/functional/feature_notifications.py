...
class NotificationsTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        self.alertnotify_dir = self.options.tmpdir / "alertnotify"
        self.blocknotify_dir = self.options.tmpdir / "blocknotify"
        self.walletnotify_dir = self.options.tmpdir / "walletnotify"
        self.shutdownnotify_dir = self.options.tmpdir / "shutdownnotify"
        self.shutdownnotify_file = self.shutdownnotify_dir / "shutdownnotify.txt"
    ...
    def run_test(self):
        ...
        assert_equal(sorted(blocks), sorted([p.name for p in self.blocknotify_dir.iterdir()]))
