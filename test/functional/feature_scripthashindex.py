...
class ScriptHashIndexTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 2
        self.extra_args = [[], ["-scripthashindex"]]

    def wait_for_index(self, height):
        self.wait_until(lambda: self.nodes[1].getindexinfo()["scripthashindex"]["synced"])
        self.wait_until(lambda: self.nodes[1].getindexinfo()["scripthashindex"]["best_block_height"] >= height)
    ...
    def run_test(self):
        ...
        self.wait_for_index(node.getblockcount())
        ...
        self.wait_for_index(block_height)
        ...
        wallet.rescan_utxos()
        self.wait_for_index(receive_height)
        ...
        self.wait_for_index(spend_height)
