...
class P2PEncrypted(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        peer3 = node0.add_outbound_p2p_connection(
            P2PInterface(), p2p_idx=0, supports_v2_p2p=False, advertise_v2_p2p=False
        )
        ...
        peer4 = node0.add_outbound_p2p_connection(
            P2PInterface(), p2p_idx=1, supports_v2_p2p=False, advertise_v2_p2p=True
        )
        ...
        peer5 = node0.add_outbound_p2p_connection(
            P2PInterface(), p2p_idx=2, supports_v2_p2p=True, advertise_v2_p2p=True
        )
        ...
        for i in range(2):
            ...
            if i:
                ...
                self.log.info(
                    "Check if blocks produced by node0's p2p connection sent as decoys aren't received by node0"
                )
                peer6.send_blocks_and_test(
                    test_blocks, node0, success=False, is_decoy=True
                )  # node0's tip doesn't advance
