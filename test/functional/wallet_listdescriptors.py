...
class ListDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.is_bdb_compiled():
            ...
            assert_raises_rpc_error(
                -4, "listdescriptors is not available for non-descriptor wallets", node.listdescriptors
            )
        ...
        assert_raises_rpc_error(
            -13, "Please enter the wallet passphrase with walletpassphrase first.", wallet.listdescriptors, True
        )
