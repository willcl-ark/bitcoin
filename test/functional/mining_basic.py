...
class MiningTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(
            -22, "Block does not start with a coinbase", node.submitblock, CBlock().serialize().hex()
        )
        assert_raises_rpc_error(
            -22, "Block does not start with a coinbase", node.submitblock, bad_block.serialize().hex()
        )
