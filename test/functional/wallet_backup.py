...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def erase_three(self):
        os.remove(os.path.join(self.nodes[0].chain_path, 'wallets', self.default_wallet_name, self.wallet_data_filename))
        os.remove(os.path.join(self.nodes[1].chain_path, 'wallets', self.default_wallet_name, self.wallet_data_filename))
        os.remove(os.path.join(self.nodes[2].chain_path, 'wallets', self.default_wallet_name, self.wallet_data_filename))
    ...
    def restore_invalid_wallet(self):
        ...
        wallet_name = "res0"
        not_created_wallet_file = os.path.join(node.chain_path, 'wallets', wallet_name)
    ...
    def restore_wallet_existent_name(self):
        ...
        wallet_name = "res0"
        wallet_file = os.path.join(node.chain_path, 'wallets', wallet_name)
    ...
    def run_test(self):
        ...
        assert os.path.exists(os.path.join(self.nodes[3].chain_path, 'wallets', "res0"))
        assert os.path.exists(os.path.join(self.nodes[3].chain_path, 'wallets', "res1"))
        assert os.path.exists(os.path.join(self.nodes[3].chain_path, 'wallets', "res2"))
        ...
        sourcePaths = [
            os.path.join(self.nodes[0].chain_path, 'wallets', self.default_wallet_name, self.wallet_data_filename),
            os.path.join(self.nodes[0].chain_path, '.', 'wallets', self.default_wallet_name, self.wallet_data_filename),
            os.path.join(self.nodes[0].chain_path, 'wallets', self.default_wallet_name),
            os.path.join(self.nodes[0].chain_path, 'wallets')]
