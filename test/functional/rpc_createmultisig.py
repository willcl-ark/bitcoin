...
class RpcCreateMultiSigTest(BitcoinTestFramework):
    ...
    def do_multisig(self, nkeys, nsigs, output_type):
        ...
        assert_raises_rpc_error(
            -22, "TX decode failed", node2.combinerawtransaction, [rawtx2["hex"], rawtx3["hex"] + "00"]
        )
        ...
        assert_raises_rpc_error(
            -25, "Input not found or already spent", node2.combinerawtransaction, [rawtx2["hex"], rawtx3["hex"]]
        )
