...
class CTransaction:
    __slots__ = ("hash", "nLockTime", "version", "sha256", "vin", "vout", "wit")
...
class CBlockHeader:
    __slots__ = ("hash", "hashMerkleRoot", "hashPrevBlock", "nBits", "nNonce", "nTime", "nVersion", "sha256")
...
class P2PHeaderAndShortIDs:
    __slots__ = ("header", "nonce", "prefilled_txn", "prefilled_txn_length", "shortids", "shortids_length")
...
class msg_getheaders:
    ...
    def __repr__(self):
        return "msg_getheaders(locator=%s, stop=%064x)" % (repr(self.locator), self.hashstop)
...
class msg_cfilter:
    ...
    def __repr__(self):
        return "msg_cfilter(filter_type={:#x}, block_hash={:x})".format(self.filter_type, self.block_hash)
...
class msg_cfheaders:
    ...
    def __repr__(self):
        return "msg_cfheaders(filter_type={:#x}, stop_hash={:x})".format(self.filter_type, self.stop_hash)
...
class msg_getcfcheckpt:
    ...
    def __repr__(self):
        return "msg_getcfcheckpt(filter_type={:#x}, stop_hash={:x})".format(self.filter_type, self.stop_hash)
...
class msg_cfcheckpt:
    ...
    def __repr__(self):
        return "msg_cfcheckpt(filter_type={:#x}, stop_hash={:x})".format(self.filter_type, self.stop_hash)
