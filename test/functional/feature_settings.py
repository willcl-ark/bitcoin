...
class SettingsTest(BitcoinTestFramework):
    ...
    def test_wallet_settings(self, settings_path):
        ...
        for wallets_data in [[10], [True], [[]], [{}], ["w1", 10], ["w1", False]]:
            with settings_path.open("w", encoding="utf8") as fp:
    ...
    def run_test(self):
        ...
        with conf.open('a', encoding="utf8") as conf:
        ...
        with altsettings.open("w", encoding="utf8") as fp:
            fp.write('{"key": "value"}')
