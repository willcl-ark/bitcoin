...
class RPCMempoolInfoTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        result = self.nodes[0].gettxspendingprevout(
            [{"txid": confirmed_utxo["txid"], "vout": 0}, {"txid": txidA, "vout": 1}]
        )
        assert_equal(
            result,
            [
                {"txid": confirmed_utxo["txid"], "vout": 0, "spendingtxid": txidA},
        ...
        assert_equal(
            result,
            [{"txid": txidE, "vout": 0, "spendingtxid": txidH}, {"txid": txidF, "vout": 0, "spendingtxid": txidH}],
        )
