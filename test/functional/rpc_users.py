...
class HTTPBasicsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].assert_start_raises_init_error(
            expected_msg=init_error, extra_args=[rpcauth_user1, rpcauth_user2, "-rpcauth="]
        )
        self.nodes[0].assert_start_raises_init_error(
            expected_msg=init_error, extra_args=[rpcauth_user1, "-rpcauth=", rpcauth_user2]
        )
        self.nodes[0].assert_start_raises_init_error(
            expected_msg=init_error, extra_args=["-rpcauth=", rpcauth_user1, rpcauth_user2]
        )
