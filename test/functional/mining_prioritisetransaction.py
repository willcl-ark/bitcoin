...
class PrioritiseTransactionTest(BitcoinTestFramework):
    ...
    def test_replacement(self):
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions(), {tx_replacee["txid"]: {"fee_delta": 100, "in_mempool": False}}
        )
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions(),
            {
                tx_replacee["txid"]: {
                    "fee_delta": 100,
                    "in_mempool": True,
                    "modified_fee": int(tx_replacee["fee"] * COIN + 100),
                }
            },
        )
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions(),
            {
                tx_replacee["txid"]: {
                    "fee_delta": COIN + 100,
                    "in_mempool": True,
                    "modified_fee": int(tx_replacee["fee"] * COIN + COIN + 100),
                }
            },
        )
    ...
    def test_diamond(self):
        ...
        assert_equal(
            ...
            {
                txid_b: {
                    "fee_delta": fee_delta_b * COIN,
                    "in_mempool": True,
                    "modified_fee": int(fee_delta_b * COIN + COIN * tx_o_b["fee"]),
                },
                txid_c: {
                    "fee_delta": (fee_delta_c_1 + fee_delta_c_2) * COIN,
                    "in_mempool": True,
                    "modified_fee": int((fee_delta_c_1 + fee_delta_c_2) * COIN + COIN * tx_o_c["fee"]),
                },
            },
        )
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions(),
            {
                txid_b: {"fee_delta": fee_delta_b * COIN, "in_mempool": False},
                txid_c: {"fee_delta": (fee_delta_c_1 + fee_delta_c_2) * COIN, "in_mempool": False},
            },
        )
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, "getprioritisedtransactions", self.nodes[0].getprioritisedtransactions, True)
        ...
        assert_equal(
            ...
            {
                txids[0][0]: {
                    "fee_delta": 3 * base_fee * COIN,
                    "in_mempool": True,
                    "modified_fee": int(3 * base_fee * COIN + COIN * 1 * base_fee),
                }
            },
        )
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions()[high_fee_tx],
            {"fee_delta": -2 * base_fee * COIN, "in_mempool": False},
        )
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions()[high_fee_tx],
            {
                "fee_delta": -2 * base_fee * COIN,
                "in_mempool": True,
                "modified_fee": int(-2 * base_fee * COIN + COIN * 3 * base_fee),
            },
        )
        for x in txids[2]:
            if x != high_fee_tx:
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions()[tx_id], {"fee_delta": self.relayfee * COIN, "in_mempool": False}
        )
        ...
        assert_equal(
            self.nodes[0].getprioritisedtransactions()[tx_id],
            {
                "fee_delta": self.relayfee * COIN,
                "in_mempool": True,
                "modified_fee": int(self.relayfee * COIN + COIN * tx_res["fee"]),
            },
        )
