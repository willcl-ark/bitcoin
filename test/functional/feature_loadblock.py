...
class LoadblockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        hash_list = tempfile.NamedTemporaryFile(dir=data_dir, mode="w", delete=False, encoding="utf-8")
        ...
        subprocess.run([sys.executable, linearize_hashes_file, cfg_file], stdout=hash_list, check=True)
