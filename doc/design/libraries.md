...
| *libbitcoin_ipc*         | IPC functionality used by *bitcoin-node*, *bitcoin-wallet* executables to communicate when [`--enable-multiprocess`](multiprocess.md) is used. |
