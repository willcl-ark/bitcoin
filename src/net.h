...
private:
    ...
    void ReleaseAndDisconnectNode(CNodeRef pnode) EXCLUSIVE_LOCKS_REQUIRED(m_nodes_mutex);
    ...
    void DeleteNode(CNodeRef pnode);
    ...
    /**
     * RAII helper to atomically create a copy of `m_nodes` with new shared ptr references.
     */
    class NodesSnapshot
    {
    public:
