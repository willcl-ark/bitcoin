...
static void AddRandomOutboundPeer(NodeId& id, std::vector<CNodeRef>& vNodes, PeerManager& peerLogic, ConnmanTestMsg& connman, ConnectionType connType)
{
