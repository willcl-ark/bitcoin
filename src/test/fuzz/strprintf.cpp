...
FUZZ_TARGET(str_printf)
{
    ...
    const std::string test_string{format_string};
    ...
    try {
        CallOneOf(
            ...
            [&] {
                ...
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeRandomLengthString(32));
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeRandomLengthString(32).c_str());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeRandomLengthString(32).c_str());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<signed char>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<signed char>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<unsigned char>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<unsigned char>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<char>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<char>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeBool());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeBool());
            });
    ...
    try {
        CallOneOf(
            ...
            [&] {
                ...
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeFloatingPoint<float>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeFloatingPoint<double>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeFloatingPoint<double>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<int16_t>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<int16_t>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<uint16_t>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<uint16_t>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<int32_t>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<int32_t>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<uint32_t>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<uint32_t>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<int64_t>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<int64_t>());
            },
            [&] {
                (void)strprintf(format_string, fuzzed_data_provider.ConsumeIntegral<uint64_t>());
                (void)tinyformat::format(test_string, fuzzed_data_provider.ConsumeIntegral<uint64_t>());
            });
    } catch (const tinyformat::format_error&) {
    }
}
