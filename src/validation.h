...
public:
    ...
    /** Remove invalidity status from a block and its ancestors only (no descendants). */
    void ResetBlockFailureFlagsSingle(CBlockIndex* pindex) EXCLUSIVE_LOCKS_REQUIRED(cs_main);
