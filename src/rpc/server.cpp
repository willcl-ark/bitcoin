    ...
    case RPCArg::Type::ARR: {
        ...
        if (arg.m_inner.size() > 1) {
            ...
            for (const auto& inner : arg.m_inner) {
                one_of.push_back(OpenRPCArgSchema(inner));
            }
    ...
    case RPCResult::Type::ARR: {
        ...
        if (result.m_inner.size() > 1) {
            ...
            for (const auto& inner : result.m_inner) {
                one_of.push_back(OpenRPCResultSchema(inner));
            }
            items.pushKV("oneOf", std::move(one_of));
                                ...
                                {{RPCResult::Type::OBJ, "", "A parameter.",
                                    {
                                        ...
                                        {RPCResult::Type::ARR, "x-bitcoin-type-str", /*optional=*/true, "Type string hints.",
                                            {{RPCResult::Type::STR, "", "A type string."}}},
