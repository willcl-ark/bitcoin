...
static RPCHelpMan addnode()
{
    return RPCHelpMan{
        ...
        "Attempts to add or remove a node from the addnode list.\n"
                ...
                "Nodes added using addnode (or -connect) are protected from DoS disconnection and IBD header/block timeout\n"
                "disconnection, and are not required to be full nodes/support SegWit as other outbound peers are (though \n"
