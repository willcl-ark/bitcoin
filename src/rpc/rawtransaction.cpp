...
static std::vector<RPCResult> ScriptPubKeyDoc() {
    return
         {
             {RPCResult::Type::STR, "asm", "Disassembly of the public key script. Values in <> are LE hex."},
    ...
    return {
        ...
        {RPCResult::Type::ARR, "vin", "",
        {
            {RPCResult::Type::OBJ, "", "",
            {
                ...
                {
                    {RPCResult::Type::STR, "asm", "Disassembly of the signature script. Values in <> are LE hex."},
...
static RPCHelpMan decodescript()
{
    return RPCHelpMan{
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                {RPCResult::Type::STR, "asm", "Script public key. Values in <> are LE hex."},
                ...
                {RPCResult::Type::OBJ, "segwit", /*optional=*/true,
                 ...
                 {
                     {RPCResult::Type::STR, "asm", "String representation of the script public key. Values in <> are LE hex."},
...
const RPCResult decodepsbt_inputs{
    RPCResult::Type::ARR, "inputs", "",
    {
        {RPCResult::Type::OBJ, "", "",
        {
            ...
            {
                {RPCResult::Type::STR, "asm", "Disassembly of the redeem script. Values in <> are LE hex."},
                {RPCResult::Type::STR_HEX, "hex", "The raw redeem script bytes, hex-encoded"},
                {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
            }},
            {RPCResult::Type::OBJ, "witness_script", /*optional=*/true, "",
            {
                {RPCResult::Type::STR, "asm", "Disassembly of the witness script. Values in <> are LE hex."},
            ...
            {
                {RPCResult::Type::STR, "asm", "Disassembly of the final signature script. Values in <> are LE hex."},
