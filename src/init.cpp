...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-rpcexpiry=<n>", strprintf("Time in seconds after which RPC requests which have not begun processing will expire (default: %d)", DEFAULT_HTTP_REQUEST_EXPIRY), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::RPC);
