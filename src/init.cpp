...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-rpccookieperms=<octal>", strprintf("Set the permissions on the RPC auth cookie file to the specified octal value on unix systems (default: %u)", PermsToOctalString(DEFAULT_COOKIE_PERMS).c_str()), ArgsManager::ALLOW_ANY, OptionsCategory::RPC);
